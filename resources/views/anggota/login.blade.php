...
@section('judul','Login Anggota')
@section('content')

    <section class=" h-screen overflow-hidden antialiased">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0 mt-28">
            <a href="#" class="flex items-center mb-6 text-3xl font-semibold text-[#164e63]">
                <img class="w-8 h-8 mr-2" src="{{ asset('/img/logo.png') }}" alt="logo">Anggota</a>
            <div class="w-full bg-[#e4ba7e] rounded-lg  shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="" method="post">
                        ...
                        <p class="text-sm font-light ml-2 ">
                            <a href="/admin/login" class="font-semibold text-[#164e63] hover:underline dark:text-primary-500">Login Sebagai Admin.</a>
                        </p>
                    </form>
                </div>
            </div>
